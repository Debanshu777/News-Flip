...
class NewsAdapter:RecyclerView.Adapter<NewsAdapter.ArticleVieHolder>(){
    inner class ArticleVieHolder(itemView: View):RecyclerView.ViewHolder(itemView)
